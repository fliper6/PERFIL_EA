...
public class PostsDAO {
	...
	public static Posts loadPostsByORMID(int idPost, LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Posts getPostsByORMID(int idPost, LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Posts loadPostsByORMID(PersistentSession session, int idPost, LockMode lockMode) throws PersistentException {
		try {
	...
	public static Posts getPostsByORMID(PersistentSession session, int idPost, LockMode lockMode) throws PersistentException {
		try {
	...
	public static List queryPosts(String condition, String orderBy, LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Posts[] listPostsByQuery(String condition, String orderBy, LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static List queryPosts(PersistentSession session, String condition, String orderBy, LockMode lockMode) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Posts as Posts");
		if (condition != null)
			sb.append(" Where ").append(condition);
		if (orderBy != null)
	...
	public static Posts[] listPostsByQuery(PersistentSession session, String condition, String orderBy, LockMode lockMode) throws PersistentException {
		try {
	...
	public static Posts loadPostsByQuery(String condition, String orderBy, LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Posts loadPostsByQuery(PersistentSession session, String condition, String orderBy, LockMode lockMode) throws PersistentException {
	...
	public static java.util.Iterator iteratePostsByQuery(String condition, String orderBy, LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static java.util.Iterator iteratePostsByQuery(PersistentSession session, String condition, String orderBy, LockMode lockMode) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Posts as Posts");
		if (condition != null)
			sb.append(" Where ").append(condition);
		if (orderBy != null)
	...
	public static boolean deleteAndDissociate(Posts posts, PersistentSession session)throws PersistentException {
		try {
			if (posts.getIdUser() != null) {
				posts.getIdUser().posts.remove(posts);
			}
