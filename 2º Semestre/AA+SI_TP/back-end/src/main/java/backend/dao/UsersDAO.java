...
public class UsersDAO {
	...
	public static Users loadUsersByORMID(int idUser, LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Users getUsersByORMID(int idUser, LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Users loadUsersByORMID(PersistentSession session, int idUser, LockMode lockMode) throws PersistentException {
		try {
	...
	public static Users getUsersByORMID(PersistentSession session, int idUser, LockMode lockMode) throws PersistentException {
		try {
	...
	public static List queryUsers(String condition, String orderBy, LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Users[] listUsersByQuery(String condition, String orderBy, LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static List queryUsers(PersistentSession session, String condition, String orderBy, LockMode lockMode) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Users as Users");
		if (condition != null)
			sb.append(" Where ").append(condition);
		if (orderBy != null)
	...
	public static Users[] listUsersByQuery(PersistentSession session, String condition, String orderBy, LockMode lockMode) throws PersistentException {
		try {
	...
	public static Users loadUsersByQuery(String condition, String orderBy, LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Users loadUsersByQuery(PersistentSession session, String condition, String orderBy, LockMode lockMode) throws PersistentException {
	...
	public static java.util.Iterator iterateUsersByQuery(String condition, String orderBy, LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static java.util.Iterator iterateUsersByQuery(PersistentSession session, String condition, String orderBy, LockMode lockMode) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Users as Users");
		if (condition != null)
			sb.append(" Where ").append(condition);
		if (orderBy != null)
	...
	public static boolean deleteAndDissociate(Users users, PersistentSession session)throws PersistentException {
		try {
			if (users.getIdRole() != null) {
				users.getIdRole().users.remove(users);
			}
