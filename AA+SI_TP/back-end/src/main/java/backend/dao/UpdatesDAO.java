...
public class UpdatesDAO {
	...
	public static Updates loadUpdatesByORMID(int idUpdate, LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Updates getUpdatesByORMID(int idUpdate, LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Updates loadUpdatesByORMID(PersistentSession session, int idUpdate, LockMode lockMode) throws PersistentException {
		try {
	...
	public static Updates getUpdatesByORMID(PersistentSession session, int idUpdate, LockMode lockMode) throws PersistentException {
		try {
	...
	public static List queryUpdates(String condition, String orderBy, LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Updates[] listUpdatesByQuery(String condition, String orderBy, LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static List queryUpdates(PersistentSession session, String condition, String orderBy, LockMode lockMode) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Updates as Updates");
		if (condition != null)
			sb.append(" Where ").append(condition);
		if (orderBy != null)
	...
	public static Updates[] listUpdatesByQuery(PersistentSession session, String condition, String orderBy, LockMode lockMode) throws PersistentException {
		try {
	...
	public static Updates loadUpdatesByQuery(String condition, String orderBy, LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static Updates loadUpdatesByQuery(PersistentSession session, String condition, String orderBy, LockMode lockMode) throws PersistentException {
	...
	public static java.util.Iterator iterateUpdatesByQuery(String condition, String orderBy, LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = UntitledPersistentManager.instance().getSession();
	...
	public static java.util.Iterator iterateUpdatesByQuery(PersistentSession session, String condition, String orderBy, LockMode lockMode) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Updates as Updates");
		if (condition != null)
			sb.append(" Where ").append(condition);
		if (orderBy != null)
	...
	public static boolean deleteAndDissociate(Updates updates, PersistentSession session)throws PersistentException {
		try {
			if (updates.getIdUser() != null) {
				updates.getIdUser().updates.remove(updates);
			}
